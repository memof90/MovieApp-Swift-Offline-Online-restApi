...
class VideosUpcommingViewCell: UICollectionViewCell {
    var videosUpcomming : ResultVideo? {
        didSet {
            updateVideo()
        }
    }
    ...
    func updateVideo() {
        guard let videos = videosUpcomming else {return}
